...
//ES6:
//import {EvenEmitter} from "./event-emitter.js";(en este caso iría con llaves ya que no lo exportamos como default)
//export var whiteboard =new EventEmitter;
var EventEmitter = require("./event-emitter");
var whiteboard = new EventEmitter;

  //window.whiteboard = new window.EventEmitter(); //viene de EventEmitter, ademas estoy exportando whiteboard
